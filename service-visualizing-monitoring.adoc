...
Jaegerへのアクセスを許可する権限を要求している場合は、［Allow selected permissions］をクリックします。Jaegerのクエリページが表示されます。
...
kind: VirtualService
metadata:
  creationTimestamp: "2021-03-02T21:41:57Z"
  generation: 1
  managedFields:
  - apiVersion: networking.istio.io/v1alpha3
    ...
    operation: Update
    time: "2021-03-02T21:41:57Z"
  name: reviews
  namespace: {{ USER_ID }}-bookinfo
  resourceVersion: "4848293"
  selfLink: /apis/networking.istio.io/v1beta1/namespaces/user2-bookinfo/virtualservices/reviews
  uid: 75996b09-1a5c-41ab-a5aa-35861d6b8fa2
spec:
  hosts:
  - reviews
  http:
